 ...
 */
export const listMapDrawings = async ({
  data,
}: {
  data: z.infer<typeof listMapDrawingsSchema>;
}) => {
...
export const createMapDrawing = async ({
  data,
}: {
  data: z.infer<typeof createMapDrawingSchema>;
}) => {
  let sessionUserId: string | undefined;
  try {
    const member = await requireCampaignMember(data.campaignId);
...
export const updateMapDrawing = async ({
  data,
}: {
  data: z.infer<typeof updateMapDrawingSchema>;
}) => {
  let sessionUserId: string | undefined;
  try {
    const member = await requireCampaignMember(data.campaignId);
...
export const deleteMapDrawing = async ({
  data,
}: {
  data: z.infer<typeof deleteMapDrawingSchema>;
}) => {
  let sessionUserId: string | undefined;
  try {
    const member = await requireCampaignMember(data.campaignId);
...
export const clearMapDrawings = async ({
  data,
}: {
  data: z.infer<typeof clearMapDrawingsSchema>;
}) => {
  let sessionUserId: string | undefined;
  try {
    const member = await requireCampaignMember(data.campaignId);
