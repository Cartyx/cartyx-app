...
export const createLocation = async ({ data }: { data: z.infer<typeof createLocationSchema> }) => {
...
export const updateLocation = async ({ data }: { data: z.infer<typeof updateLocationSchema> }) => {
  let sessionUserId: string | undefined;
  try {
    const member = await requireCampaignMember(data.campaignId);
    sessionUserId = member.sessionUserId;
...
export const deleteLocation = async ({ data }: { data: z.infer<typeof deleteLocationSchema> }) => {
  let sessionUserId: string | undefined;
  try {
    const member = await requireCampaignMember(data.campaignId);
    sessionUserId = member.sessionUserId;
...
export const listLocations = async ({ data }: { data: z.infer<typeof listLocationsSchema> }) => {
  let sessionUserId: string | undefined;
  try {
    const member = await requireCampaignMember(data.campaignId);
    sessionUserId = member.sessionUserId;
...
export const getLocation = async ({ data }: { data: z.infer<typeof getLocationSchema> }) => {
  let sessionUserId: string | undefined;
  try {
    const member = await requireCampaignMember(data.campaignId);
    sessionUserId = member.sessionUserId;
...
export const addLocationImage = async ({
  ...
  data: z.infer<typeof addLocationImageSchema>;
}) => {
  let sessionUserId: string | undefined;
  try {
    const member = await requireCampaignMember(data.campaignId);
...
export const deleteLocationImage = async ({
  ...
  data: z.infer<typeof deleteLocationImageSchema>;
}) => {
  let sessionUserId: string | undefined;
  try {
    const member = await requireCampaignMember(data.campaignId);
